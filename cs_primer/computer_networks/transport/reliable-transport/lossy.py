...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--upstream_host",
        help="Host to which the upstream server is bound",
        default="127.0.0.1",
    )
    parser.add_argument(
        "--upstream_port",
        type=int,
        help="Port to which the upstream server is bound",
        default=8000,
    )
    parser.add_argument(
        "--inbound_port",
        type=int,
        help="Port to which the client should send data",
        default=7000,
    )
    parser.add_argument("--drop_rate", type=float, default=0.2)
    parser.add_argument("--dup_rate", type=float, default=0.2)
    parser.add_argument("--reorder_rate", type=float, default=0.2)
    ...
    while True:
        data, from_addr = sock.recvfrom(4096)  # receive application layer data
        ...
        # BASIC; only drop packets from client to server (indent this)
        ...
        # if from_addr[1] != args.upstream_port: # BASIC
